...
Description: Demonstrates input/output control by combining LEDs and switches. Practice conditional logic and state changes in Arduino sketches.
...
How to Run: Open .ino, wire LEDs and switches, upload sketch, test response to switch input.
